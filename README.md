...
* Participated in optimizing [pycbc_multi_inpiral](https://github.com/gwastro/pycbc/blob/master/bin/pycbc_multi_inspiral) identifying bottlenecks using profilers like cprof2dot and scalene. See [PyGRB_performance](https://github.com/sebastiangomezlopez/PyGRB_performance) repository.
